        ...
        builder: (context, drawerProvider, _) {
          return ClipRRect(
              borderRadius: borderRadius(
                  radius: drawerProvider.isOpenDrawer ? 20 : 0),
              child:
              Scaffold(
                        ...
                        child: TabBarView(
                            ...
                            children: [
                              ...
                              isLoadingMyResults
                                  ...
                                  appText.noResults, appText
                                      .youHaveNoQuizResults)
                                ...
                                isLoadingStudentResults
                                  ...
                                  child: Column(
                                    children: [
                                      ...
                                      ...List.generate(
                                          studentResults.length, (index) {
                                        return userCard(
                                            studentResults[index].user
                                                ?.avatar ?? '',
                                            studentResults[index].user
                                                ?.fullName ?? '',
                                            studentResults[index].webinar
                                                ?.title ?? '',
                                            timeStampToDate(
                                            ...
                                            gradeStatus: studentResults[index]
                                                .status,
                                            userGrade: '${studentResults[index]
                                                .usergrade}/${studentResults[index]
                                                .quiz?.totalmark}'
                                        );
                                      }),
                                            ...
                                            nextRoute(
                                                ...
                                                arguments: [
                                                  Quiz.fromJson(
                                                    ...
                                                    ..title = listQuiz[index]
                                                        .getTitle()
                                                    ..questioncount = listQuiz[index]
                                                        .questionCount
                                                    ..avrage = listQuiz[index]
                                                        .avrage
