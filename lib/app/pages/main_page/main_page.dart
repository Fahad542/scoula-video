    ...
    return WillPopScope(
      onWillPop: () async {
        if (locator<PageProvider>().page == PageNames.home) {
          ...
          await MainWidget.showExitDialog();
              ...
              body: AdvancedDrawer(
                ...
                backdrop: Container(
                  ...
                  decoration: BoxDecoration(
                    gradient: drawerbackGradint()
                  ),
                  //color: drawerbackGradint() ,
                                  ...
                                  Positioned.fill(
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        ...
                                        MainWidget.navItem(PageNames.Quizes, pageProvider.page, appText.quizzes, AppAssets.quizzesSvg, (){
                                          pageProvider.setPage(PageNames.Quizes);
                                        }),
