...
class _SingleCoursePageState extends State<SingleCoursePage> with SingleTickerProviderStateMixin{
  ...
  void initState() {
    ...
    // } else {
    //   // Handle case when videoDemo is null or empty
    //   print("Video demo URL is not available");
    //   // You can also show an error message or placeholder here if necessary.
    // }
  ...
  print(courseData!.videoDemoSource);
    print(courseData!.videoDemo);
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            if(courseData?.videoDemo != null)...{
                              if(courseData?.videoDemoSource == 'youtube' ||
                                  courseData?.videoDemoSource == 'vimeo'

                              )...{
                                VideoPlayerWidget(videoUrl: courseData?.videoDemo ?? '')
                                ...
                                ...{
                                  CourseVideoPlayer(courseData?.videoDemo ?? '',
