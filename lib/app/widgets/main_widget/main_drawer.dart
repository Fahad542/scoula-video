...
import '../../pages/main_page/home_page/Terms_and_conditions_page/terms_and_conditions.dart';
                    ...
                    child: SingleChildScrollView(
                      ...
                      child: Column(
                        children: [
                          ...
                          menuItem(
                              appText.support, AppAssets.supportSvg, (){
                            if(hasAccess(canRedirect: true)){
                              nextRoute(SupportMessagePage.pageName);
                            }
                          }
                          ),
                          menuItem(appText.terms, AppAssets.terms, (){
                           if(hasAccess(canRedirect: true))
                            {
                              Navigator.push(
                                context,
                                MaterialPageRoute(builder: (context) => Terms_and_condiiton()),
                              );
                             // Navigator.pushNamed(context, Navigator.push(
                              //   context,
                              //   MaterialPageRoute(builder: (context) => SecondPage()),
                              // );());
                              //nextRoute(Terms_and_condiiton.pageNam);
                            }
                          }
                          ),
                          menuItem(token.isNotEmpty
                                        ? appText.logOut
                                        : appText.login,
                              token.isNotEmpty
                                  ?
